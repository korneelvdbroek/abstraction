...
class TupleArraySpec extends FlatSpec with Matchers {
  ...
  "sortedData" should "return the indices of the TupleArray sorted along the 0th axes" in {
    UnsortedTuples.sortedData(0)._1 shouldBe Array(5, 0, 1, 2, 4, 3)
    UnsortedTuples.sortedData(0)._2 shouldBe Array(1, 2, 3, 5, 4, 0)
  }

  it should "return the indices of the TupleArray sorted along the 1st axes" in {
    UnsortedTuples.sortedData(1)._1 shouldBe Array(5, 3, 4, 1, 2, 0)
    UnsortedTuples.sortedData(1)._2 shouldBe Array(5, 3, 4, 1, 2, 0)
  }
