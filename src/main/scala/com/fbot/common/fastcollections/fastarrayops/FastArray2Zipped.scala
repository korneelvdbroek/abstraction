...
/**
  ...
  *
  */
class FastArray2Zipped[El1, El2](val zipArray: (ImmutableArray[El1], ImmutableArray[El2])) extends AnyVal {
  ...
  def groupBy[Key: ClassTag](f: (El1, El2) => Key)(implicit evidence1: ClassTag[El1], evidence2: ClassTag[El2]): Map[Key, (ImmutableArray[El1], ImmutableArray[El2])] = {
  ...
  def filter(f: (El1, El2) ⇒ Boolean)(implicit evidence1: ClassTag[El1], evidence2: ClassTag[El2]): FastArray2Zipped[El1, El2] = {
  ...
  def sliceWhile(p: (El1, El2) => Boolean, from: ArrayIndex)(implicit evidence1: ClassTag[El1], evidence2: ClassTag[El2]): FastArray2Zipped[El1, El2] = {
    val arrayBuilder1 = Array.newBuilder[El1]
    val arrayBuilder2 = Array.newBuilder[El2]
...
object FastArray2Zipped {
  ...
  implicit def tuple2FastArray2Zipped[El1, El2](zipArray: (ImmutableArray[El1], ImmutableArray[El2])): FastArray2Zipped[El1, El2] = {
