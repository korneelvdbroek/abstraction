...
import com.fbot.common.immutable.{DoubleImmutableArrayMath, ImmutableArrayOps}
...
/**
  ...
  *
  */
case class Tuple(repr: mutable.WrappedArray[Double]) extends AnyVal with ImmutableArrayOps[Double, Tuple] with DoubleImmutableArrayMath[Tuple] {
